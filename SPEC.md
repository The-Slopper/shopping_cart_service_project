# Especificacao Tecnica — Shopping Cart Service

| Campo | Valor |
|---|---|
| Repositorio | `shopping_cart_service_project` |
...
Servico de carrinho de compras. Este documento descreve requisitos, arquitetura e criterios de aceite.
